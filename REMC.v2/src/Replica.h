...
class Replica
{
	...
	float boundingValue;
	void setBoundingValue(float value) { boundingValue = value; };
	inline float getBoundingValue() {	return boundingValue;	};
	...
	void setTranslateStep(float t) { translateStep = t; }
	void setRotateStep(double r) { rotateStep = r; }
	void setTemperature(float t) { temperature = t; }
	void setTemperatureBeta(float t) { temperatureBeta = t; }
	void setLabel(short l) { label = l; }
