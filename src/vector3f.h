...
public:
    ...
    bool almost_equal(const Vector3f v, const float eps=0.00001);
    ...
    Vector3f set(float xi, float yi, float zi) {
        x = xi;
        y = yi;
        z = zi;
        return Vector3f(x,y,z);
    ...
    Vector3f dotV(float xi,float yi,float zi) {
        return dotV(Vector3f(xi,yi,zi));
    };
...
public:
    ...
    Vector3d(long xi, long yi, long zi) {
        x=xi;
        y=yi;
        z=zi;
    };
...
public:
    ...
    Vector3double(double xi, double yi, double zi) {
        x=xi;
        y=yi;
        z=zi;
    };
